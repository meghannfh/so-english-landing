    ...
    return(
        <div className="flex flex-col w-screen">
            ...
            <div className='px-6 py-24 md:px-24 lg:px-56'>
                ...
                <h3 className="mt-6 font-semibold leading-relaxed md:leading-loose text-2xl md:text-2xl text-[#282828]">私は、友達や生徒や他の英語の先生方から「ペラペラだね」と言っていただくことはたまにありますが、自分自身をそのように思ったことは一度もありません。</h3>
