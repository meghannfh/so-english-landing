...
export default function AboutThree(){
    return(
        <div className="w-screen">
            <div className="w-full flex flex-col gap-12 py-10 items-center justify-center px-6">
            ...
            <div className='py-10 px-6 md:px-24 lg:px-56'>
                ...
                <p className="pt-20 lg:mt-20 text-2xl leading-relaxed md:leading-loose md:text-lg font-medium text-slate-900">
