...
export default function FiveSteps() {
    return (
        <div className="flex flex-col w-screen">
            <div className='px-6 pt-24 pb-10 md:px-24 lg:px-56'>
                <h2 className="text-5xl md:text-3xl font-semibold text-slate-900">Methodology</h2>
                <h3 className="mt-6 font-semibold leading-relaxed md:leading-loose text-2xl md:text-2xl text-[#282828]">ここでは実際にSo ENGLISH!英語教室で、生徒にどのような学習方法を提案しているかをお話します。「どうやったら英語が話せるようになるか？」一言で言うのは難しいですが、大切なのは「総合的な力をつける」ことです。以下の図をご覧ください。</h3>
            </div>
            <div className="h-76 md:h-[24rem] lg:h-[32rem] px-6 md:px-24 lg:px-56 flex justify-center">
                <img className="h-full rounded-3xl" alt={'diagram'} src={fiveStepsDiagram}/>
            </div>
            <div className='px-6 pt-10 pb-24 md:px-24 lg:px-56'>
