...
export default function AboutTwo(){
    return(
        <div className="w-screen">
            <div className="max-h-[56rem] w-full flex flex-col lg:flex-row gap-12 items-center justify-center px-6">
                ...
                <p className="lg:w-96 mt-6 text-2xl leading-relaxed md:leading-loose md:text-lg font-semibold text-slate-600">
            ...
            <div className='px-6 md:px-36 lg:px-80'>
                <p className="lg:mt-20 mt-10 text-2xl leading-relaxed md:leading-loose md:text-lg font-semibold text-slate-600">
