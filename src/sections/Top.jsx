        ...
        <div>
            ...
            <div className="font-bold h-[33rem] md:h-[50rem] relative overflow-hidden">
                ...
                <div className="flex flex-row items-center justify-center gap-6 text-3xl md:text-4xl w-full absolute bottom-10 text-white">
                    <span className='one animate fadeInUp p-2'>
                    <BsInstagram />
                    </span>
                    <span className="two animate fadeInUp p-2">
                    <BsTwitter />
                    </span>
                    <span className="three animate fadeInUp p-2">
                    <BsYoutube />
                    </span>
                    <span className="four animate fadeInUp p-2">
                    <BsSpotify />
                    </span>
                    </div>
            </div>
